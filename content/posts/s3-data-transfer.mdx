...
async function main() {
  const options = {
    accessKeyId: "AKIAYD4NSHJKLSQ5EN2MZKIOPYWI",
    secretAccessKey: "UOEZL6epEAHGT2XKNNHROV+tzarFNLTP3gUxKKIHGFSSDDS1V3bPNh",
...
<p>
 ...
 <p>Github Repo : https://github.com/ridhamz/nodejs-s3-files-uploads </p>
  </div>
</div>
