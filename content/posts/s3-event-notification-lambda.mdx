...
<div style={{ marginTop: "20px" }}>
  <div style={{ padding: "5px" }}>
    ...
    <p>
     ...
     <p>
      <strong>Note 2</strong> : If you encounter the error "Runtime.ImportModuleError: Error: Cannot find module 'aws-sdk'" whenever your Lambda function is triggered, try downgrading your Node.js runtime from the AWS Management Console. This issue is known to occur with the Node.js 18 runtime, and switching to an earlier version may resolve it.
    </p>
