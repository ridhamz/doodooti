...
<div style={{ marginTop: '20px' }}>
  ...
  <div style={{ padding: '5px' }}>
  <p>
  To establish an SSH connection to an AWS EC2 instance, follow these steps:
</p>
   <ol>
  <li style={{marginTop: "5px"}}>
    <strong>Open the terminal</strong>: Navigate to the folder where you downloaded the key pair.
  </li>
  <li style={{marginTop: "5px"}}>
    <strong>Change the permissions for the key pair</strong>: Type the following command in the terminal:
    <br />
    <code>chmod 400 "MZ-Bastina-Host-Key.pem"</code>
  </li>
  <li style={{marginTop: "5px"}}>
    <strong>Copy the public IP address</strong>: Copy the public IP address of the Bastion Host.
  </li>
  <li style={{marginTop: "5px"}}>
    <strong>Run the SSH command</strong>: Run the following SSH command to connect:
    <br />
...
<div style={{ marginTop: '20px' }}>
  ...
  <div style={{ padding: '5px' }}>
    <p>
      ...
      simplifying management and reducing potential vulnerabilities. With a
      properly configured Bastion Host, you now have a secure and efficient way
      to access your private infrastructure.
    </p>
  </div>
</div>
